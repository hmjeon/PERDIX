...
module Para
    ...
    logical :: para_write_401   = .false.       !  Cross-sectional geometry,                Section_Chimera_Cross_Geometry,   "_cross_geo.bild"
    ...
    logical :: para_write_505   = .false.       !  Txt file on edge length,                 Basepair_Write_Edge_Length,       "_edge_length.txt"
    ...
    logical :: para_chimera_102_info = .false.  !  Plot with edge and point number (_init_geo.bild)
    ...
    logical :: para_chimera_303_info = .false.  !  Plot with edge and point number (_mod_geo.bild)
    logical :: para_chimera_401_info = .false.  !  Plot with edge and point number (_cross_geo.bild)
