...
module Exam_PERDIX
    ...
    public Exam_PERDIX_Square                   !  1. Square
    public Exam_PERDIX_Honeycomb                !  2. Honeycomb
    public Exam_PERDIX_Circle                   !  3. Circle
    public Exam_PERDIX_Wheel                    !  4. Wheel
    public Exam_PERDIX_Ellipse                  !  5. Ellipse

    ! Quadrilateral-mesh objects
    public Exam_PERDIX_Rhombic_Tiling           !  6. Rhombic tiling
    public Exam_PERDIX_Quarter_Circle           !  7. Quarter circle
    public Exam_PERDIX_Cross                    !  8. Cross
    public Exam_PERDIX_Arrowhead                !  9. Arrowhead
    public Exam_PERDIX_Annulus                  ! 10. Annulus

    ! N-polygon-mesh objects
    public Exam_PERDIX_Cairo_Penta_Tiling       ! 11. Cairo pentagonal tiling
    public Exam_PERDIX_Lotus                    ! 12. Lotus
    public Exam_PERDIX_Hexagonal_Tiling         ! 13. Hexagonal tiling
    public Exam_PERDIX_Prismatic_Penta_Tiling   ! 14. Prismatic pentagonal tiling
    public Exam_PERDIX_Hepta_Penta_Tiling       ! 15. Heptagon and pentagon tiling

    ! Variable vertex-number
    public Exam_PERDIX_4_Sided_Polygon          ! 16. 4-sided polygon
    public Exam_PERDIX_5_Sided_Polygon          ! 17. 5-sided polygon
    public Exam_PERDIX_6_Sided_Polygon          ! 18. 6-sided polygon

    ! Variable edge-length
    public Exam_PERDIX_L_Shape_42bp             ! 19. L-Shape with 42-bp edge length
    public Exam_PERDIX_L_Shape_63bp             ! 20. L-Shape with 63-bp edge length
    public Exam_PERDIX_L_Shape_84bp             ! 21. L-Shape with 84-bp edge length

    ! Variable internal mesh
    public Exam_PERDIX_Curved_Arm_Quad          ! 19. Curved arm with quad mesh
    public Exam_PERDIX_Curved_Arm_Tri           ! 20. Curved arm with tri mesh
    public Exam_PERDIX_Curved_Arm_Mix           ! 21. Curved arm with mixed mesh

    ! Different mesh patterns with pump geometry
    public Exam_PERDIX_Pump_Quad                ! Pump with quad mesh
    public Exam_PERDIX_Pump_Tri                 ! Pump with tri mesh
    public Exam_PERDIX_Pump_Eng                 ! Pump with eng mesh

    ! Different mesh patterns with s-shape geometry
    public Exam_PERDIX_S_Shape_Quad             ! S-shape with quad mesh
    public Exam_PERDIX_S_Shape_Tri              ! S-shape with tri mesh
    public Exam_PERDIX_S_Shape_Eng              ! S-shape with eng mesh

    ! Different mesh patterns with small house geometry
    public Exam_PERDIX_Small_House_Quad         ! Small house with quad mesh
    public Exam_PERDIX_Small_House_Tri          ! Small house with tri mesh

    ! Others
    public Exam_PERDIX_Plate_3x4                ! Plate (3x4)
    public Exam_PERDIX_Pentagon                 ! Pentagon
    public Exam_PERDIX_Star                     ! Star
    public Exam_PERDIX_Plumeria                 ! Plumeria
    public Exam_PERDIX_Stickman                 ! 2D stickman
    public Exam_PERDIX_Quarter_Circle_Tri       ! Quarter circle with tri mesh
    public Exam_PERDIX_Disk_Tri                 ! Disk with tri mesh
    public Exam_PERDIX_Circle_Tri_Fine          ! Circle with tri fine mesh
    public Exam_PERDIX_Ellipse_Tri_Fine         ! Ellipse with tri fine mesh
    public Exam_PERDIX_L_Shape_Irregular        ! L-shape with irregular mesh
    public Exam_PERDIX_N_Polygon                ! N-sided polygon
    public Exam_PERDIX_N_Polygon_Mesh           ! N-sided polygon with mesh
    public Exam_PERDIX_Triangle

    public Exam_PERDIX_Hexagon
    public Exam_PERDIX_Octagon
    public Exam_PERDIX_Octagon_Cross_1
    public Exam_PERDIX_Octagon_Cross_2

    public Exam_PERDIX_Controllable_Plate
    public Exam_PERDIX_Quarter_Hemi_Hole

    private Exam_PERDIX_Cross_Point
    private Exam_PERDIX_Merge_Point_Face_Quad
    private Exam_PERDIX_Merge_Point_Face_Tri
    private Exam_PERDIX_Comp_XYZ
...
subroutine Exam_PERDIX_Square(prob, geom)
...
end subroutine Exam_PERDIX_Square

! -----------------------------------------------------------------------------

! Example of honeycomb with the triangular mesh
subroutine Exam_PERDIX_Honeycomb(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Circle

! -----------------------------------------------------------------------------

! Example of wheel with the triangular mesh
subroutine Exam_PERDIX_Wheel(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Ellipse

! -----------------------------------------------------------------------------

! Example of Rhombic tiling with the quadrilateral mesh
subroutine Exam_PERDIX_Rhombic_Tiling(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom

    prob.name_prob = "06_Rhombic_Tiling"
    call Mani_Set_Prob(prob, [231, 76, 60])
...
end subroutine Exam_PERDIX_Rhombic_Tiling

! -----------------------------------------------------------------------------

! Example of quarter circle with the quadrilateral mesh
subroutine Exam_PERDIX_Quarter_Circle(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    call Exam_PERDIX_Merge_Point_Face_Quad(n, joint, conn, count_n, count_e, geom)
...
end subroutine Exam_PERDIX_Quarter_Circle

! -----------------------------------------------------------------------------

! Example of cross with the quadrilateral mesh
subroutine Exam_PERDIX_Cross(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Cross

! -----------------------------------------------------------------------------

! Example of arrowhead with the quadrilateral mesh
subroutine Exam_PERDIX_Arrowhead(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Arrowhead

! -----------------------------------------------------------------------------

! Example of annulus with the quadrilater mesh
subroutine Exam_PERDIX_Annulus(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Annulus

! -----------------------------------------------------------------------------

! Example of Cairo pentagonal tiling
subroutine Exam_PERDIX_Cairo_Penta_Tiling(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom

    ! Set problem
    prob.name_prob = "11_Cairo_Penta_Tiling"
    call Mani_Set_Prob(prob, [247, 147, 30])
...
end subroutine Exam_PERDIX_Cairo_Penta_Tiling

! -----------------------------------------------------------------------------

! Example of lotus
subroutine Exam_PERDIX_Lotus(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Lotus

! -----------------------------------------------------------------------------

! Example of hexagonal tiling
subroutine Exam_PERDIX_Hexagonal_Tiling(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Hexagonal_Tiling

! -----------------------------------------------------------------------------

! Example of prismatic pentagonal tiling
subroutine Exam_PERDIX_Prismatic_Penta_Tiling(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Prismatic_Penta_Tiling

! -----------------------------------------------------------------------------

! Example of heptagonal pentagonal tiling
subroutine Exam_PERDIX_Hepta_Penta_Tiling(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Hepta_Penta_Tiling

! -----------------------------------------------------------------------------

! Example of 4-sided polygon
subroutine Exam_PERDIX_4_Sided_Polygon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    call Mani_Set_Prob(prob, [77, 175, 74])
...
end subroutine Exam_PERDIX_4_Sided_Polygon

! -----------------------------------------------------------------------------

! Example of 5-sided polygon
subroutine Exam_PERDIX_5_Sided_Polygon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_5_Sided_Polygon

! -----------------------------------------------------------------------------

! Example of 6-sided polygon
subroutine Exam_PERDIX_6_Sided_Polygon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_6_Sided_Polygon

! -----------------------------------------------------------------------------

! Example of L-Shape with 42-bp edge length
subroutine Exam_PERDIX_L_Shape_42bp(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_L_Shape_42bp

! -----------------------------------------------------------------------------

! Example of L-Shape with 63-bp edge length
subroutine Exam_PERDIX_L_Shape_63bp(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    geom.face(11).n_poi = 4; allocate(geom.face(11).poi(4)); geom.face(11).poi(1:4) = [ 16, 17, 20, 19 ]
    geom.face(12).n_poi = 4; allocate(geom.face(12).poi(4)); geom.face(12).poi(1:4) = [ 17, 18, 21, 20 ]
end subroutine Exam_PERDIX_L_Shape_63bp

! -----------------------------------------------------------------------------

! Example of L-shape with 84-bp edge length
subroutine Exam_PERDIX_L_Shape_84bp(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    geom.face(11).n_poi = 4; allocate(geom.face(11).poi(4)); geom.face(11).poi(1:4) = [ 16, 17, 20, 19 ]
    geom.face(12).n_poi = 4; allocate(geom.face(12).poi(4)); geom.face(12).poi(1:4) = [ 17, 18, 21, 20 ]
end subroutine Exam_PERDIX_L_Shape_84bp

! -----------------------------------------------------------------------------

! Example of curved arm with quadrilateral mesh
subroutine Exam_PERDIX_Curved_Arm_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Curved_Arm_Quad

! -----------------------------------------------------------------------------

! Example of curved arm with constant directional triangular mesh
subroutine Exam_PERDIX_Curved_Arm_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Curved_Arm_Tri

! -----------------------------------------------------------------------------

! Example of curved arm with mixed directional triangular mesh
subroutine Exam_PERDIX_Curved_Arm_Mix(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Curved_Arm_Mix

! -----------------------------------------------------------------------------

! Example of pump geometry with quad mesh
subroutine Exam_PERDIX_Pump_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Pump_Quad

! -----------------------------------------------------------------------------

! Example of pump geometry with tri mesh
subroutine Exam_PERDIX_Pump_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Pump_Tri

! -----------------------------------------------------------------------------

! Example of pump geometry with eng mesh
subroutine Exam_PERDIX_Pump_Eng(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Pump_Eng

! -----------------------------------------------------------------------------

! Example of S-shape with quad mesh
subroutine Exam_PERDIX_S_Shape_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_S_Shape_Quad

! -----------------------------------------------------------------------------

! Example of S-shape with tri mesh
subroutine Exam_PERDIX_S_Shape_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_S_Shape_Tri

! -----------------------------------------------------------------------------

! Example of S-shape with eng mesh
subroutine Exam_PERDIX_S_Shape_Eng(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_S_Shape_Eng

! -----------------------------------------------------------------------------

! Example of small house with quad mesh
subroutine Exam_PERDIX_Small_House_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Small_House_Quad

! -----------------------------------------------------------------------------

! Example of small house with tri mesh
subroutine Exam_PERDIX_Small_House_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Small_House_Tri

! -----------------------------------------------------------------------------

! Example of plate with uniform quad mesh
subroutine Exam_PERDIX_Plate_3x4(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Plate_3x4

! -----------------------------------------------------------------------------

! Example of pentagon
subroutine Exam_PERDIX_Pentagon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Pentagon

! -----------------------------------------------------------------------------

! Example of star
subroutine Exam_PERDIX_Star(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Star

! -----------------------------------------------------------------------------

! Example of plumeria
subroutine Exam_PERDIX_Plumeria(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Plumeria

! -----------------------------------------------------------------------------

! Example of stickman
subroutine Exam_PERDIX_Stickman(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Stickman

! -----------------------------------------------------------------------------

! Example of L-shape
subroutine Exam_PERDIX_L_Shape_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_L_Shape_Tri

! -----------------------------------------------------------------------------

! Example of quarter circle with tri mesh
subroutine Exam_PERDIX_Quarter_Circle_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    call Exam_PERDIX_Merge_Point_Face_Tri(n, joint, conn, count_n, count_e, geom)
    ...
    ! Deallocate data structure
    deallocate(edge, joint, conn)
end subroutine Exam_PERDIX_Quarter_Circle_Tri

! -----------------------------------------------------------------------------

! Example of disk with tri mesh
subroutine Exam_PERDIX_Disk_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Disk_Tri

! -----------------------------------------------------------------------------

! Example of circle generated by Distmesh using 0.3 factor
subroutine Exam_PERDIX_circle_Tri_Fine(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_circle_Tri_Fine

! -----------------------------------------------------------------------------

! Example of ellipse generated by Distmesh using 0.4 factor
subroutine Exam_PERDIX_Ellipse_Tri_Fine(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Ellipse_Tri_Fine

! -----------------------------------------------------------------------------

! Example of L-shape with irregular
subroutine Exam_PERDIX_L_Shape_Irregular(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_L_Shape_Irregular

! -----------------------------------------------------------------------------

! Example of Plate with distorted quad mesh
subroutine Exam_PERDIX_Plate_Distorted_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    do j = 1, n_j_poi
        do i = 1, n_i_poi
            ...
            call Exam_PERDIX_Cross_Point(edge(1,i,:), edge(2,i,:), edge(3,j,:), edge(4,j,:), xy)
    ...
    deallocate(edge)
end subroutine Exam_PERDIX_Plate_Distorted_Quad

! -----------------------------------------------------------------------------

! Example of Plate with distorted tri mesh
subroutine Exam_PERDIX_Plate_Distorted_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! deallocate edge data
    deallocate(edge)
end subroutine Exam_PERDIX_Plate_Distorted_Tri

! -----------------------------------------------------------------------------

! Example of hyperbolic paraboloid with quad mesh
subroutine Exam_PERDIX_Hyperbolic_Paraboloid_Quad(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Hyperbolic_Paraboloid_Quad

! -----------------------------------------------------------------------------

! Example of hyperbolic paraboloid with quad mesh
subroutine Exam_PERDIX_Hyperbolic_Paraboloid_Tri(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
...
end subroutine Exam_PERDIX_Hyperbolic_Paraboloid_Tri

! -----------------------------------------------------------------------------

! Example of n-polygon without mesh
subroutine Exam_PERDIX_N_Polygon(prob, geom, n)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    integer, intent(in) :: n
    ...
    ! Set problem
    prob.name_prob = trim(adjustl(int2str(n)))//"_Side"
    call Mani_Set_Prob(prob, [52, 152, 219])
    ...
    ! Set connectivity
    geom.face(1).n_poi = n
    allocate(geom.face(1).poi(n))

    do i = 1, n
        geom.face(1).poi(i) = i
    end do
end subroutine Exam_PERDIX_N_Polygon

! -----------------------------------------------------------------------------

! Example of n-polygon with tri mesh
subroutine Exam_PERDIX_N_Polygon_Mesh(prob, geom, n)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    integer, intent(in) :: n
...
end subroutine Exam_PERDIX_N_Polygon_Mesh

! -----------------------------------------------------------------------------

! Example of triangle with arbitrary angle
subroutine Exam_PERDIX_Triangle(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set problem
    prob.name_prob = "Exam_PERDIX_Triangle"
    call Mani_Set_Prob(prob, [52, 152, 219])

    length = float(prob.n_edge_len)
    angle  = 45.0d0
    ...
    geom.face(1).poi(2) = 2
    geom.face(1).poi(3) = 3
end subroutine Exam_PERDIX_Triangle

! -----------------------------------------------------------------------------

! Example of hexagon
subroutine Exam_PERDIX_Hexagon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set position vector
    do i = 1, n
        geom.iniP(i).pos(2) = 10.0d0 * dcos(2.0d0 * pi * dble(i) / dble(n))
        geom.iniP(i).pos(3) = 10.0d0 * dsin(2.0d0 * pi * dble(i) / dble(n))
        geom.iniP(i).pos(1) = 0.0d0
    end do

    ! Set connectivity
    geom.face(1).n_poi = 6
    allocate(geom.face(1).poi(6))
    geom.face(1).poi(1) = 1; geom.face(1).poi(2) = 2
    geom.face(1).poi(3) = 3; geom.face(1).poi(4) = 4
    geom.face(1).poi(5) = 5; geom.face(1).poi(6) = 6
end subroutine Exam_PERDIX_Hexagon

! -----------------------------------------------------------------------------

! Example of octagon
subroutine Exam_PERDIX_Octagon(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set connectivity
    geom.face(1).n_poi = 8
    allocate(geom.face(1).poi(8))
    geom.face(1).poi(1) = 1; geom.face(1).poi(2) = 2
    geom.face(1).poi(3) = 3; geom.face(1).poi(4) = 4
    geom.face(1).poi(5) = 5; geom.face(1).poi(6) = 6
    geom.face(1).poi(7) = 7; geom.face(1).poi(8) = 8
end subroutine Exam_PERDIX_Octagon

! -----------------------------------------------------------------------------

! Example of octagonal with cross 1
subroutine Exam_PERDIX_Octagon_Cross_1(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set problem
    prob.name_prob = "Octagon_Cross_1"
    call Mani_Set_Prob(prob, [77, 175, 74])
...
end subroutine Exam_PERDIX_Octagon_Cross_1

! -----------------------------------------------------------------------------

! Example of octagonal with cross 2
subroutine Exam_PERDIX_Octagon_Cross_2(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set problem
    prob.name_prob = "Octagon_Cross_2"
    call Mani_Set_Prob(prob, [77, 175, 74])
    ...
    geom.face(1).poi(1) = 1; geom.face(1).poi(2) = 8; geom.face(1).poi(3) = 9; geom.face(1).poi(4) = 2
    geom.face(2).poi(1) = 8; geom.face(2).poi(2) = 7; geom.face(2).poi(3) = 6; geom.face(2).poi(4) = 9
    geom.face(3).poi(1) = 9; geom.face(3).poi(2) = 6; geom.face(3).poi(3) = 5; geom.face(3).poi(4) = 4
    geom.face(4).poi(1) = 2; geom.face(4).poi(2) = 9; geom.face(4).poi(3) = 4; geom.face(4).poi(4) = 3
end subroutine Exam_PERDIX_Octagon_Cross_2

! -----------------------------------------------------------------------------

! Example of the controllable plate
subroutine Exam_PERDIX_Controllable_Plate(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom
    ...
    ! Set problem
    prob.name_prob = "Controllable_Plate"
    call Mani_Set_Prob(prob, [52, 152, 219])
...
end subroutine Exam_PERDIX_Controllable_Plate

! ---------------------------------------------------------------------------------------

! Example of quarter hemisphere with hole
subroutine Exam_PERDIX_Quarter_Hemi_Hole(prob, geom)
    type(ProbType), intent(inout) :: prob
    type(GeomType), intent(inout) :: geom

    double precision :: radius, length, angle1, angle2
    integer :: i, j, n_node, n_elem, index, n, nr, ny

    ! Set problem
    prob.name_prob = "Quarter_Hemi_Hole"
    call Mani_Set_Prob(prob, [52, 152, 219])
    ...
    do i = 1, ny + 1
        do j = 1, nr + 1
            index  = index + 1
            angle1 = (90.0d0-dble(j-1)*(90.0d0/dble(nr)))*(pi/180.0d0)
            angle2 = (62.0d0-dble(i-1)*(62.0d0/dble(ny)))*(pi/180.0d0)

            geom.iniP(index).pos(3) = radius*dcos(angle2)*dcos(angle1)
            geom.iniP(index).pos(1) = radius*dcos(angle2)*dsin(angle1)
            geom.iniP(index).pos(2) = radius*dsin(angle2)
        end do
    end do
    ...
    do i = 1, ny
        do j = 1, nr
            ...
            geom.face(index).poi(1) = (nr+1)*(i-1) + (j-1) + 1
            geom.face(index).poi(2) = (nr+1)*(i-1) + (j-1) + 2
            geom.face(index).poi(3) = (nr+1)*(i+0) + (j-1) + 2
            geom.face(index).poi(4) = (nr+1)*(i+0) + (j-1) + 1
        end do
    end do
end subroutine Exam_PERDIX_Quarter_Hemi_Hole

! -----------------------------------------------------------------------------

! Return cross point
subroutine Exam_PERDIX_Cross_Point(AP1, AP2, BP1, BP2, CP)
...
end subroutine Exam_PERDIX_Cross_Point

! -----------------------------------------------------------------------------

! Merge points and faces for quad mesh
subroutine Exam_PERDIX_Merge_Point_Face_Quad(n, joint, conn, n_node, n_element, geom) 
    type(GeomType),   intent(inout) :: geom
    ...
    do i = 1, (n+1)**2
        ...
        flag = 0
        do j=1, n_node
            if( Exam_PERDIX_Comp_XYZ( joint(i,:), geom.iniP(j).pos(:) ) == 1) then
                flag = j; exit
            end if
        end do
    ...
    do i = 1, n * n
        ...
        do j = 1, 4
            do k = 1, n_node
                if(Exam_PERDIX_Comp_XYZ(joint(conn(i,j), :), geom.iniP(k).pos(:)) == 1) exit
            end do
            
            geom.face(n_element).poi(j) = k
        end do
    end do
end subroutine Exam_PERDIX_Merge_Point_Face_Quad

! -----------------------------------------------------------------------------

! Merge points and faces for tri mesh
subroutine Exam_PERDIX_Merge_Point_Face_Tri(n, joint, conn, n_node, n_element, geom)  
    type(GeomType), intent(inout) :: geom
    double precision, intent(in)  :: joint((n+1)**2, 3)
...
end subroutine Exam_PERDIX_Merge_Point_Face_Tri

! -----------------------------------------------------------------------------

! Return 0 or 1
integer function Exam_PERDIX_Comp_XYZ(a, b)
   double precision, intent(in) :: a(3), b(3) 
   double precision :: d

   Exam_PERDIX_Comp_XYZ = 0
   d = dsqrt((a(1)-b(1))**2.0d0 + (a(2)-b(2))**2.0d0 + (a(3)-b(3))**2.0d0)
   if(d < 1.0d-5) Exam_PERDIX_Comp_XYZ = 1
end function Exam_PERDIX_Comp_XYZ

! -----------------------------------------------------------------------------

end module Exam_PERDIX